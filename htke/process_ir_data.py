...
class Peaks():
	...
	def linear_correction(self, processed_ir_data, no_reactions, points_per_reaction):
		...
		Ignores the first point as this may be of a different SPKA interval size.
	...
	def linear_correction_all(self, processed_ir_data, no_reactions, points_per_reaction):
		
		"""
		Fits the raw data to a straight line and returns data smoothed as this line.
		Includes the first point. Do not use if initial conv is different from interval size.
	...
	def plot_corrections(self, processed_ir_data):
		"""
